...
TEST_GRADE_HOMEWORK_ONE = Grade(TEST_VALUE_ONE, TEST_NAME_ONE)
TEST_GRADE_HOMEWORK_ONE_DUPE = Grade(TEST_VALUE_ONE, TEST_NAME_ONE)
...
TEST_CATEGORY_TWO = Category(TEST_NAME_TWO, TEST_KEYWORDS, [TEST_GRADE_HOMEWORK_ONE])
...
class TestGrade(unittest.TestCase):
    ...
    """ Test(s) for __repr__ """
    def test_repr(self):
        expected = "Grade({0}, {1}, {2})".format(TEST_VALUE_ONE, TEST_NAME_ONE, DEFAULT_GRADE_MAXIMUM)
